  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <nav className="sticky top-0 z-40 bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#0f6b57] flex items-center justify-center text-white font-black text-base shrink-0">
              S
            </div>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-3 text-sm text-gray-400">
              <span>ครู</span><span>·</span><span>นักเรียน</span><span>·</span><span>ผู้ปกครอง</span>
            </div>
            <button
              onClick={onLoginClick}
              className="bg-[#0f6b57] hover:bg-[#0a5544] text-white text-sm font-bold px-5 py-2 rounded-xl transition-colors"
            >
              เข้าสู่ระบบ
            </button>
          </div>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg, #042d1e 0%, #0f6b57 55%, #1a7a60 100%)' }}
      >
        {/* Blobs */}
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <div className="w-20 h-20 rounded-3xl border border-white/20 bg-white/10 mx-auto mb-6 flex items-center justify-center">
          ...
          <p className="text-white/70 text-base md:text-lg max-w-lg mx-auto mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <button
              onClick={onLoginClick}
              className="bg-white text-[#0f6b57] font-bold px-8 py-3 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all w-full sm:w-auto"
            >
              เข้าสู่ระบบ →
            </button>
            <button
              onClick={onLoginClick}
              className="border border-white/40 text-white font-semibold px-8 py-3 rounded-xl hover:bg-white/10 transition-colors w-full sm:w-auto"
            >
              ดูข้อมูลโรงเรียน
            </button>
          </div>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-3 gap-4">
          {[
            ...
            <div key={l} className="bg-white rounded-2xl p-5 text-center shadow-sm">
              ...
              <p className="text-2xl md:text-3xl font-black text-[#0f6b57]">{n}</p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-gray-900">ระบบออกแบบมาเพื่อทุกคน</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {ROLE_CARDS.map(({ icon, title, subtitle, features, from, to }) => (
              <div
                key={title}
                onClick={onLoginClick}
                className="relative overflow-hidden rounded-2xl cursor-pointer text-white p-6 hover:-translate-y-1 hover:shadow-2xl transition-all duration-250 group"
              ...
              >
                ...
                <div className="relative space-y-4">
                  ...
                  <p className="text-sm font-bold group-hover:underline">เข้าใช้งาน →</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-black text-gray-900 text-center mb-8">ข้อมูลโรงเรียน</h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={name} className="p-5 rounded-2xl border-2 border-gray-100 hover:border-[#0f6b57] hover:shadow-md transition-all cursor-pointer">
                <div className="text-2xl mb-3">{icon}</div>
                <h3 className="font-bold text-[#0f6b57] text-sm mb-1">{name}</h3>
      ...
      {/* ── CTA ── */}
      <section className="py-14 px-4 text-center text-white" style={{ background: 'linear-gradient(135deg, #0f6b57, #22a07a)' }}>
        <h2 className="text-2xl md:text-3xl font-black mb-2">พร้อมเริ่มต้นแล้วหรือยัง?</h2>
        <p className="text-white/70 mb-6 text-base">เข้าสู่ระบบเพื่อดูข้อมูลของคุณ</p>
        <button
          onClick={onLoginClick}
          className="bg-white text-[#0f6b57] font-bold px-10 py-3 rounded-xl shadow-lg hover:-translate-y-0.5 hover:shadow-xl transition-all"
        >
          เข้าสู่ระบบ →
        </button>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-6 pb-6 border-b border-white/10">
            <div className="w-9 h-9 rounded-xl bg-[#0f6b57] flex items-center justify-center font-black">S</div>
            <div>
              <p className="font-bold text-sm">โรงเรียนสารสาสน์</p>
              <p className="text-xs text-green-400">Bilingual Education</p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <h3 className="font-bold text-xs text-green-400 uppercase tracking-wider mb-2">ที่อยู่</h3>
              <p className="text-sm text-white/50 leading-relaxed">99 ถนนตัวอย่าง แขวงการศึกษา<br />กรุงเทพฯ 10260</p>
            </div>
            <div>
              <h3 className="font-bold text-xs text-green-400 uppercase tracking-wider mb-2">ติดต่อ</h3>
              <p className="text-sm text-white/50">02-000-0000<br />contact@sarasas.example</p>
            </div>
            <div>
              <h3 className="font-bold text-xs text-green-400 uppercase tracking-wider mb-2">Social Media</h3>
